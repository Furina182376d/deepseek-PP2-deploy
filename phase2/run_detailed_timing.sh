#!/bin/bash
# Run detailed per-phase timing breakdown for PP=1 TP=4
# Usage: bash phase2/run_detailed_timing.sh
...
CUDA_VISIBLE_DEVICES=4,5,6,7 python profile_detailed_timing.py
